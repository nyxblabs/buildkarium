import { join, normalize } from 'nyxpath'
...
import type { BuildEntry, MimikraBuildEntry } from './types'
...
export function inferEntries(
   ...
   for (const output of outputs) {
      ...
      if (isDir) {
         ...
         (entry as MimikraBuildEntry).format = output.type
      }
   }
...
export function getEntrypointPaths(path: string) {
